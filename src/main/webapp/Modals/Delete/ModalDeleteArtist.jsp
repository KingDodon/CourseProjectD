...
<div class="modal fade" id="DeleteArtistModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
     style="z-index: 1052">
    <div class="modal-dialog modal-dialog-centered modal-md" style="z-index: 1052">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="delArtistForm" style="display: none" action="${pageContext.request.contextPath}/deleteArtist"
                      method="post">
                    <input type="hidden" id="artistRemoveInput" name="artist_id">
                </form>
